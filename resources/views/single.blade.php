                    ...
                    <div class="card-body">
                        ...
                        <div class="reaction d-flex align-items-center gap-2">
                            <div class="d-flex align-items-center gap-3">
                                @if (isset($hasReaction->type) && $hasReaction->type === 'like')
                                    <button type="submit" class="likeBtn btn btn-sm btn-light py-2 px-3 d-flex align-items-center gap-1" {{ $hasReaction->type === 'like' ? 'disabled' : '' }}>
                                        <span>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                @if (isset($hasReaction->type) && $hasReaction->type === 'dislike')
                                    <button type="submit" class="dislikeBtn btn btn-sm btn-light py-2 px-3 d-flex align-items-center gap-1" {{ $hasReaction->type === 'dislike' ? 'disabled' : '' }}>
                                        <span>
